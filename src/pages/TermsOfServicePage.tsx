      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          {buildSection(
            ...
            '   - 이벤트 정보 등록, 수정, 삭제 및 관리\n' +
            '   - 이벤트 정보 검색, 조회 및 카테고리별 분류\n' +
            '   - 위치 기반 이벤트 검색 및 지도 표시\n' +
            '   - 관심 이벤트 즐겨찾기 및 알림 서비스\n' +
            '   - 이벤트 채팅방을 통한 참여자 간 실시간 소통\n' +
            '   - 개인 이벤트 생성 및 관리\n' +
            '   - 장소 정보 조회 및 방문 기록\n' +
            '   - 배지 시스템 및 도전 과제\n' +
            '   - 경험치(XP) 및 레벨 시스템\n' +
            '   - 사용자 프로필 관리 및 활동 통계\n' +
            '   - 소셜 미디어(X/Twitter) 계정 연동\n' +
            '   - 푸시 알림 서비스\n' +
            '   - 콘텐츠 신고 및 관리 기능\n' +
            '2. 서비스는 연중무휴, 1일 24시간 제공함을 원칙으로 합니다.\n' +
            '3. 일부 서비스는 회원가입 및 로그인이 필요할 수 있습니다.'
          )}
          ...
          {buildSection(
            ...
            '   - 타인의 권리를 침해하는 행위\n' +
            '   - 서비스의 보안을 위협하는 행위\n' +
            '   - 허위 정보 또는 타인의 개인정보를 도용하는 행위\n' +
            '   - 채팅방에서 욕설, 비방, 음란물 등을 게시하는 행위\n' +
            '   - 부적절한 목적으로 위치 정보를 수집하거나 악용하는 행위\n' +
          ...
          {buildSection(
            '제7조 (콘텐츠 관리)',
            '1. 이용자가 게시한 콘텐츠(이벤트 정보, 채팅 메시지, 프로필 정보 등)에 대한 모든 책임은 해당 이용자에게 있습니다.\n' +
            '2. 회사는 다음에 해당하는 콘텐츠를 사전통지 없이 삭제하거나 이용을 제한할 수 있습니다:\n' +
            '   - 불법적이거나 부적절한 콘텐츠\n' +
            '   - 타인의 권리를 침해하는 콘텐츠\n' +
            '   - 서비스의 안정성을 해치는 콘텐츠\n' +
            '   - 허위 정보나 스팸성 콘텐츠\n' +
            '3. 회사는 이용자의 신고를 받아 24시간 이내에 부적절한 콘텐츠를 검토하고 조치합니다.\n' +
            '4. 이벤트 정보는 작성자 본인 또는 관리자만 수정 및 삭제할 수 있습니다.\n' +
            '5. 채팅방 관리자는 부적절한 참여자를 강퇴할 수 있는 권한을 가집니다.'
          )}
